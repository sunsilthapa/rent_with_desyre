...
const SingleProductCard = ({ bgColor, category, title, price, imageSrc }) => {
  return (
    <div className={`flex-shrink-0 m-3 relative overflow-hidden ${bgColor} rounded-lg max-w-xs  shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-xl`}>
      ...
      <div className="relative pt-2 px-5 flex items-center justify-center">
